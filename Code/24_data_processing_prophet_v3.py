...
OUTPUT_DIRECTORY_PATH = "../Data/Output/Prophetv3/"
...
def process_camera_data(
    ...
    camera_df = camera_df[camera_df["ds"] <= CUTOFF_DATE]

    feature_cols = ["ds", "y"] + [
        c for c in camera_df.columns
        if c not in ["ds", "y", "Year", "Month", "Day", "Starting time", "days_since_record"]
    ]
